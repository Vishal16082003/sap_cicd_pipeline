...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "demo/empsal/employeesalary/test/integration/FirstJourney",
    "demo/empsal/employeesalary/test/integration/EmployeesListJourney",
    "demo/empsal/employeesalary/test/integration/EmployeesObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
